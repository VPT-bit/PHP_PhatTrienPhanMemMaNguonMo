<?php
// --- Xoá bảo hành ---
if (isset($_GET['Ma_bao_hanh'])) {
    $id = $_GET['Ma_bao_hanh'];
    // Lấy tên ảnh của sản phẩm
    $query_image = "SELECT Hinh_anh FROM san_pham WHERE Ma_bao_hanh = '$id'";
    ...
    // Xóa bảo hành
    $delete_product_cat = "DELETE FROM bao_hanh WHERE Ma_bao_hanh='$id'";
        ...
        echo '<div id="alert-box" class="alert alert-success"
          ...
          <script>
              setTimeout(function() {
                  ...
                  window.location.href = "index_admin.php?page=list_product_warranty";
              });
          </script>';
    } else {
        echo "Lỗi xóa bảo hành: " . mysqli_error($conn);
    }
}

// --- Tìm dữ liệu bảo hành ---
$search_result = isset($_GET['search']) ? trim($_GET['search']) : '';
$where_search = '';
if ($search_result != '') {
    $where_search = "WHERE Thoi_gian LIKE '%$search_result%'";
}
...
$where_search
ORDER BY CAST(SUBSTRING(Ma_bao_hanh, 2) AS UNSIGNED) ASC
LIMIT $start, $rows_per_page
";
$result_to_show = mysqli_query($conn, $query_to_show);

// Lấy tổng số dòng để tính tổng số trang
$query_count = "SELECT * FROM bao_hanh $where_search";
...
<div class="card-header py-3 d-flex justify-content-between align-items-center flex-wrap">
    <h6 class="m-0 font-weight-bold text-primary">Danh sách bảo hành</h6>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item <?php if ($current_page <= 1) echo 'disabled'; ?>">
                    ...
                    $prev_link = "index_admin.php?page=list_product_warranty&page_num=$prev_page";
                ...
                for ($p = 1; $p <= $total_pages; $p++) {
                    $link = "index_admin.php?page=list_product_warranty&page_num=$p";
                ...
                <li class="page-item <?php if ($current_page >= $total_pages) echo 'disabled'; ?>">
                    ...
                    $next_link = "index_admin.php?page=list_product_warranty&page_num=$next_page";
